...
__NOTE__: Extra spaces before or after the code have no meaning and should be ignored.
...
__NOTE__: For coding purposes you have to use ASCII characters `.` and `-`, not Unicode characters.
